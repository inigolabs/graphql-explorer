...
import { Expand, IconCheck } from "../../../components/Icon/Icon";
    ...
    <div className={classNames(styles.response, styles.card)}>
      ...
      <div className={styles.main}>
        <TabView
          ...
          actions={<div className={styles.tabInfo}>{renderInfo(true)}</div>}
        >
          {tabsNode}
        </TabView>
      ...
      <div className={styles.footer}>{renderInfo(false)}</div>
    </div>
  );
}
